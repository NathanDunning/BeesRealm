...
export default class ScrollTwo extends Phaser.Scene {
    ...
    create() {
        ...
        // add back button
        var button = this.add.image(centerX - 80, centerY + 240, "back").setDepth(3)
        ...
        // add next button
        var button = this.add.image(centerX + 80, centerY + 240, "okay").setDepth(3)
        button.setInteractive()
        button.on("pointerup", () => {
            this.scene.resume(CST.SCENES.GAME)
        ...
        var gatherer = this.add.image(centerX, centerY - 70, "gatherer").setDepth(3)

        // add text
        const sceneText = 'There are 4 types of bees available in your colony. The first type of bee you unlock is the Gatherer. The Gatherer bee is identified by its yellow colour.\n\n\nIn order to collect pollen, you must command and guide your gatherer to a pollen tile.\n\nLet\'s start with that'
